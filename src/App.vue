...
<template>
  <div class="min-h-screen flex flex-col bg-gray-50">
    <!-- Header -->
    <header class="flex justify-between items-center px-6 py-4 bg-orange-500 text-black">
      <div class="font-medium">Click and ship</div>
    ...
    <!-- Hero -->
    <section class="bg-orange-500 text-center py-16 px-4">
    ...
    <!-- Footer -->
    <footer class="bg-orange-500 text-center py-6 text-white font-medium">
      Tout droit réserver
    </footer>
  </div>
</template>
